...
---
{{< alert style="info" >}}
This page contains release notes for [GroupDocs.Metadata for .NET 16.11.0](http://downloads.groupdocs.com/metadata/net/new-releases/groupdocs.metadata-for-.net-16.11.0/)
{{< /alert >}}
