...
using GroupDocsMetadataVisualStudioPlugin.GUI;
using GroupDocsMetadataVisualStudioPlugin.Properties;

namespace GroupDocsMetadataVisualStudioPlugin
{
    public class Connect : Extensibility.IDTExtensibility2, IDTCommandTarget
    {
        ...
        private const string GROUPDOCS_MENU_TOOLTIP = "Download and Run GroupDocs.Metadata for .NET API Examples";

        private const string WORDS_COMMAND_NAME = "GroupDocsMetadataVSPlugin";
        private const string WORDS_COMMAND_CAPTION = "New GroupDocs.Metadata Example Project";
        private const string WORDS_COMMAND_TOOLTIP = "Download and Run GroupDocs.Metadata for .NET API Examples";
